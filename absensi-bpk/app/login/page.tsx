    ...
    <div className="flex h-screen bg-slate-100 font-sans overflow-hidden">
      ...
      <div className="w-1/2 bg-white flex flex-col p-8 border-r-4 border-accent">
        ...
        <div className="grow flex flex-col items-center justify-center">
          <div className="w-full max-w-md aspect-square bg-slate-200 rounded-2xl border-4 border-secondary flex flex-col items-center justify-center relative overflow-hidden shadow-inner">
        ...
        <div className="mt-8 text-center">
          ...
          >
            <LogIn size={16} /> Kembali ke Absensi
          </button>
        </div>
      </div>
